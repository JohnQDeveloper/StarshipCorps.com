...
return [
    ...
    'fleet.menu_label' => 'Menu da frota',
    'fleet.menu_roster' => 'Escala',
    'fleet.assign_route' => 'Designar coleta',
    'fleet.route_kicker' => 'Ordens de recursos',
    'fleet.route_ship' => 'Nave com capitão',
    'fleet.route_sector' => 'Setor',
    'fleet.assign_route_button' => 'Designar coleta',
    'fleet.route_saved' => 'Coleta designada.',
    'fleet.route_invalid' => 'Escolha uma nave com capitão e um setor válido.',
    'fleet.route_save_failed' => 'Não foi possível salvar a designação de coleta.',
    'fleet.route_no_ships_title' => 'Nenhuma nave com capitão',
    'fleet.route_no_ships_body' => 'Designe um capitão a uma nave antes de enviá-la para coletar recursos.',
    'fleet.route_none' => 'Nenhuma coleta designada.',
    'fleet.gathering_status' => 'Status da coleta',
    'fleet.gathering_active' => 'Coletando',
    'fleet.gathering_returning' => 'Retornando para descarregar',
    'fleet.cargo' => 'Carga',
    ...
    'starbase.tier' => 'Tier',
    'starbase.storage_kicker' => 'Armazenamento ilimitado',
    'starbase.resource_storage' => 'Armazenamento de recursos',
    'starbase.storage_unlimited' => 'Capacidade ilimitada',
];
