...
return [
    ...
    'fleet.weapon' => 'Weapon',
    'fleet.mining' => 'Mining',
    'fleet.coordinates' => 'Current coordinates',
    ...
    'fleet.menu_label' => 'Fleet menu',
    'fleet.menu_roster' => 'Roster',
    'fleet.assign_route' => 'Assign Gathering',
    'fleet.route_kicker' => 'Resource orders',
    'fleet.route_ship' => 'Ship with captain',
    'fleet.route_sector' => 'Sector',
    'fleet.assign_route_button' => 'Assign gathering',
    'fleet.route_saved' => 'Gathering assigned.',
    'fleet.route_invalid' => 'Choose a ship with a captain and a valid sector.',
    'fleet.route_save_failed' => 'Gathering assignment could not be saved.',
    'fleet.route_no_ships_title' => 'No captained ships',
    'fleet.route_no_ships_body' => 'Assign a captain to a ship before sending it to gather resources.',
    'fleet.route_none' => 'No gathering assigned.',
    'fleet.gathering_status' => 'Gathering status',
    'fleet.gathering_active' => 'Gathering',
    'fleet.gathering_returning' => 'Returning to unload',
    'fleet.cargo' => 'Cargo',
    ...
    'starbase.tier' => 'Tier',
    'starbase.storage_kicker' => 'Unlimited storage',
    'starbase.resource_storage' => 'Resource storage',
    'starbase.storage_unlimited' => 'Unlimited capacity',
];
